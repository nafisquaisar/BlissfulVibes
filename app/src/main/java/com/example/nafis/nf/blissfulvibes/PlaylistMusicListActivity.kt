...
import com.example.nafis.nf.blissfulvibes.databinding.ActivityPlaylistMusicListBinding
   ...
   private lateinit var adapter: MusicAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.PlaylistShufflebtn.setOnClickListener {
            val intent=Intent(this,PlaymusicList::class.java)
    ...
    private fun showBottomSheetDialog() {
        ...
        bottomSheetView.findViewById<TextView>(id.addSong).setOnClickListener {
            startActivity(Intent(this,add_song_playlist::class.java))
